...
#define LOG_RAINDEER_PREFIX COL_YELLOW "Raindeer: " COL_RESET
...
_Noreturn void* raindeer_thread_routine(void* args)
{
    ...
    while(true)
    {
        ...
        pthread_mutex_lock(thread_args->raindeer_returned_mutex);
        ...
        pthread_cond_wait(thread_args->presents_delivered_condition, thread_args->raindeer_returned_mutex);
        ...
        pthread_mutex_unlock(thread_args->raindeer_returned_mutex);
    }
